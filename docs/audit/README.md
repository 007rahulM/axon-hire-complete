...
> Each issue has: what it is, why it matters, exact fix, and which branch to do it in.
...
|---|-------|----------|--------|
| 1 | MongoDB connects twice | 🔴 Critical | ✅ Fixed |
| 2 | Auth middleware logs all headers | 🔴 Critical | ✅ Fixed |
| 3 | JWT stored in localStorage | 🔴 Critical | 🔵 Branch 7 |
...
| 11 | No Redis caching layer | 🟡 Performance | Branch 3 |
...
| 19 | No full-text search | 🔵 Feature | Branch 3 |
...
| 25 | No error monitoring (Sentry) | 🔵 Feature | Branch 6 |
| 26 | No product analytics (PostHog) | 🔵 Feature | Branch 6 |
| 27 | Resume scoring is gameable | 🟣 AI | Branch 4 |
| 28 | No semantic matching | 🟣 AI | Branch 4 |
| 29 | AI models try sequentially | 🟣 AI | Branch 4 |
...
| 42 | No CI/CD pipeline | ⚙️ Quality | Branch 6 |
| 43 | No env config validation | ⚙️ Quality | Branch 6 |
| 44 | Render free tier cold starts | 🏗️ Arch | Branch 6 |
| 45 | No message queue for background jobs | 🏗️ Arch | Branch 3 |
