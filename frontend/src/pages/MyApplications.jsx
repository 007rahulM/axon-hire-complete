      ...
      {selectedApp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fadeIn">
          <div className="bg-[#0f172a] border border-slate-700 rounded-2xl shadow-2xl max-w-2xl w-full my-8 flex flex-col max-h-[90vh]">
            ...
            {/* Header */}
            <div className="bg-[#020617] p-6 border-b border-slate-800 flex justify-between items-start sticky top-0 z-10">
            ...
            {/* Footer */}
            <div className="p-6 bg-[#020617] border-t border-slate-800 flex justify-end sticky bottom-0">
