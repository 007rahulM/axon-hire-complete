...
//               Axon<span className="text-indigo-400">Hire</span>
//             </h1>
//           </div>
...
//               <Link to="/admin-dashboard" className="text-red-400 font-bold hover:text-red-300">
//                 Admin Panel
//               </Link>
//             )}
...
//                   className="bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95"
//                 >
//                   Join Axon
//                 </button>
//               </>
...
//                   className="text-red-400 hover:text-red-300 text-sm font-bold px-4 py-2 border border-red-500/20 hover:bg-red-500/10 rounded-xl transition-all"
//                 >
//                   Logout
//                 </button>
//               </div>
...
//                {isLoggedIn ? (
//                   <p className="text-slate-400 text-sm">Signed in as <span className="text-white font-bold">{user?.name}</span></p>
//                ) : (
//                   <p className="text-slate-400 text-sm italic">Unlock AI features by signing in.</p>
//                )}
//             </div>
...
//             {isRecruiter && (
//               <>
//                 <button onClick={() => navigate("/recruiter-dashboard")} className="block w-full text-left p-3 text-indigo-400 hover:bg-slate-800 rounded-xl font-medium">Recruiter Dashboard</button>
//                 <button onClick={() => navigate("/post-job")} className="block w-full text-left p-3 text-indigo-400 hover:bg-slate-800 rounded-xl font-medium">Post a New Job</button>
//               </>
//             )}
